...
func InnerProduct(a []*big.Int, b []*big.Int, EC CryptoParams) *big.Int {
	if len(a) != len(b) {
...
func VectorAdd(v []*big.Int, w []*big.Int, EC CryptoParams) []*big.Int {
	if len(v) != len(w) {
...
func VectorHadamard(v, w []*big.Int, EC CryptoParams) []*big.Int {
	if len(v) != len(w) {
...
func VectorAddScalar(v []*big.Int, s *big.Int, EC CryptoParams) []*big.Int {
	result := make([]*big.Int, len(v))
...
func ScalarVectorMul(v []*big.Int, s *big.Int, EC CryptoParams) []*big.Int {
	result := make([]*big.Int, len(v))
...
func PowerVector(l int, base *big.Int, EC CryptoParams) []*big.Int {
...
func RandVector(l int, EC CryptoParams) []*big.Int {
	result := make([]*big.Int, l)
...
func VectorSum(y []*big.Int, EC CryptoParams) *big.Int {
	result := big.NewInt(0)
